...
const Support = () => {
  return (
    <div className="bg-[url('/assets/img/crop_1.jpg')] bg-cover bg-center min-h-screen py-12 px-6 md:px-12 lg:px-24">
      {/* Header Section */}
      <div className="text-center mb-12">
        <h1 className="text-5xl font-extrabold text-green-800 mb-4">Support</h1>
        <p className="text-lg text-gray-900 bg-white bg-opacity-70 p-4 rounded-lg inline-block">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
        <div className="bg-white bg-opacity-80 rounded-lg shadow-lg p-6">
          <h2 className="text-3xl font-semibold text-green-700 mb-4">Contact Information</h2>
        ...
        <div className="bg-white bg-opacity-80 rounded-lg shadow-lg p-6">
          <h2 className="text-3xl font-semibold text-green-700 mb-4">Send Us an Email</h2>
          <form>
            <div className="mb-4">
      ...
      <div className="text-center">
        <h2 className="text-3xl font-semibold text-green-700 mb-4">Need More Help?</h2>
        <p className="text-gray-700 bg-white bg-opacity-70 p-4 rounded-lg inline-block">
